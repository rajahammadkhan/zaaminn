<!-- Sidebar area start -->
<div class="sidebar__area" style="z-index: 999 !important;">
    ...
    <div class="sidebar__brand">
        <a href="{{ route('admin.dashboard') }}">
            <img src="{{ asset(IMG_LOGO_PATH . $allsettings['footer_logo']) }}" alt="icon" style="padding: 3rem;">
        </a>
    </div>
    <ul id="sidebar-menu" class="sidebar__menu">
        ...
        <li class="{{ isset($menu) && $menu == 'sellerProduct' ? 'mm-active' : '' }}">
            <a href="{{ route('seller.sellerProduct') }}">
                <img src="{{ asset('admin/images/icons/sidebar/layout.svg') }}" alt="icon">
                <span>{{ __('Post your Ad') }}</span>
            </a>
        </li>
{{--        @canany(['user-list'])--}}
