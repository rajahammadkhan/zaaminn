...
{{--                            </div>--}}
                           ...
                           <div style="margin:10px;margin-top: 30px">
                               <p style="color: #0c0c0c"> | </p>
                           </div>
                                 <div>

                                     <a href="{{url('/seller/login')}}">Become a seller</a>
                                 </div>
        ...
        <div class="header-middle" style="padding: 1rem 0;">
            <div class="container">
...
{{--                        </div>--}}
                        ...
                        <div class="cart single-btn">
                            <a data-bs-toggle="offcanvas" href="#cartOffcanvasSidebar" role="button"
                                ...
                                <div class="btn-right">
                                    <span class="btn-text">{{ __('Cart') }}</span>
                                    @php
            ...
            <nav class="menu-area">
                <ul class="main-menu">
                    ...
                    <li class="menu-item mega-menu-parent">
                        <a class="menu-link" href="#">Categories <i
...
{{--                    </li>--}}
                    ...
                    @foreach (Category() as $item)
                        <li class="menu-item">
                            <a class="menu-link" href="{{ route('category.product', $item->id) }}">
                                {{ langConverter($item->en_Category_Name, $item->fr_Category_Name) }}
                            </a>
                        </li>
                    @endforeach
