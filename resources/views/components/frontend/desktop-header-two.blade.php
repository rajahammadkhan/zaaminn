        ...
        <div class="header-bottom">
            <nav class="menu-area">
                <ul class="main-menu">
                    ...
                    <li class="menu-item mega-menu-parent dropdown">
                        <a class="menu-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Categories
                            <i class="arrow-icon fas fa-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDarkDropdownMenuLink">
                            @foreach (Category() as $item)
                                <li class="list-group-item"><a class="dropdown-item" style="font-size: 18px"
