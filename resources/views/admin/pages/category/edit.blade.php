                                    ...
                                    <div class="form-vertical__item bg-style">
                                        <form enctype="multipart/form-data" method="POST" action="{{route('admin.category.update')}}">
                                            ...
                                            <div class="input__group mb-25">
                                                <label>{{ __('Category Image '.langString('en'))}}</label>
                                                <input type="file" id="category_image" class="dropify" name="category_image" value="{{ old('category_image') }}"
                                                    placeholder="Name" value="{{ asset($edit->category_image) }}" data-default-file="{{ asset($edit->category_image) }}">
                                            </div>
                                            <div class="input__group mb-25">
