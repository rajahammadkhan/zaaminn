                                        ...
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" class="form-control" id="price" name="price"
                                                    value="{{ $product->Price }}" placeholder="{{ __('Price') }}">
                                            </div>
                                            <div class="input__group mb-25">
                                            ...
                                            @else
                                                <div class="input__group mb-25">
                                                    ...
                                                    <input type="text" class="form-control" name="digital_link"
                                                        id="digital-link" value="{{ $product->digital_link }}"
                                                        placeholder="{{ __('Link') }}">
                                                </div>
                                            @endif
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="input__group mb-25">
                                                        <label for="digital-file">{{ __('License Name') }}</label>
                                                        <input type="text" class="form-control" name="license_name"
                                                            id="license-name" value="{{ $product->license_name }}"
                                                            placeholder="{{ __('License Name') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="input__group mb-25">
                                                        <label for="digital-file">{{ __('License Key') }}</label>
                                                        <input type="text" class="form-control" name="license_key"
                                                            id="license-key" value="{{ $product->license_key }}"
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <textarea name="en_about" id="en_about" class="form-control"
                                                    placeholder="{{ __('About') }}">{!! $product->en_About !!}</textarea>
                                            </div>
                                            ...
                                            <div class="input__group mb-25">
                                                <label
                                                    for="en_additionalinformation">{{ __('AdditionalInformation') }}</label>
                                                <textarea name="en_additionalinformation" id="en_additionalinformation"
                                                    class="form-control summernote">{!! $product->en_AdditionalInformation !!}</textarea>
                                            </div>
                                            <div class="input__group mb-25">
                                            ...
                                            <div class="input__group mb-25">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" value="1"
                                                        ...
                                                        name="on_arrival" class="custom-control-input" id="customSwitch5">
                                                    <label class="custom-control-label"
                                        ...
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <textarea name="fr_about" id="fr_about" class="form-control"
                                                    placeholder="{{ __('About') }}">{!! $product->fr_About !!}</textarea>
                                            </div>
                                            <div class="input__group mb-25">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <textarea name="fr_additionalinformation" id="fr_additionalinformation"
                                                    class="form-control summernote">{!! $product->fr_AdditionalInformation !!}</textarea>
                                            </div>
