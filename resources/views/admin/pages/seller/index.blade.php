@extends('admin.master', ['menu' => 'admins', 'submenu' => 'sellerProduct'])
        ...
        <div class="customers__area bg-style mb-30">
            <div class="item-title">
                <div class="col-xs-6">
                    ...
                    <button data-bs-toggle="modal" data-bs-target="#createAccessory" class="btn btn-md btn-info">{{ __('Add Accessory')}}</button>
                </div>
            </div>           
            <ul class="nav nav-tabs" id="myTab" role="tablist">                       
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="product-tab" data-bs-toggle="tab" data-bs-target="#product" type="button" role="tab" aria-controls="product" aria-selected="false">Seller Products</button>
                </li>
                <li class="nav-item" role="presentation">
                        ...
                        <table id="BlogTable" class="row-border data-table-filter table-style">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-capitalize"><b> {{isset($product->user->name) ? $product->user->name:'NA'}}</b> </td>
                                    <td>
                                        @php
                                        ...
                                        @endphp
                                        <span class="p-2 rounded cursor-pointer {{$badgeClass}}" data-product-id="{{ $product->id }}" data-toggle="tooltip" title="Click to toggle">{{$approvalStatus ? 'Approved' : 'Pending'}}</span>
                                    </td>
                                    <td>
                    ...
                    <div class="customers__table">
                        <table id="BlogTable" class="row-border data-table-filter table-style">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-capitalize">{{ isset($product->category) ? preg_replace('/(?<=\w)(?=[A-Z])/', ' ', $product->category) : 'NA' }}</td>
                                    <td>{{isset($product->sub_category) ? preg_replace('/(?<=\w)(?=[A-Z])/', ' ', $product->sub_category) :'NA'}} </td>
                                    <td>{{isset($product->price) ? $product->price:'NA'}} </td>
                                    <td>
                                        @if($product->image == null)
                                        <p class='text-center text-danger'>Image not Uploaded</p>
                                    ...
                                    <td>
                                        @php
                                            ...
                                            $badgeClass = $approvalStatus ? 'bg-success text-white' : 'bg-warning text-white';
                                        @endphp
                                        <span class="p-2 rounded cursor-pointer {{$badgeClass}}" data-product-id="{{ $product->id }}" data-toggle="tooltip-acc" title="Click to toggle">{{$approvalStatus ? 'Approved' : 'Pending'}}</span>
                                    </td>
                                    <td>
                                        @if($product->is_sold == 0)
                                        In Stock
                                    ...
                                    <td>
                                        <div class="action__buttons">
                                            <a onclick="editAccessory({{ $product->id }})" class="btn-action">
                                                <i class="fas fa-pen-to-square"></i>
                                            </a>
                                            <a href="{{url('seller/accessoryDelete/'.$product->id)}}" class="btn-action delete">
                                                <i class="fas fa-trash-alt"></i>
                                            </a>
                                        </div>
                                    </td>
                                            ...
                                            <fieldset class="shadow-sm p-3 bg-white mb-3">
                                                ...
                                                <div class="row no-gutters">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <input type="text" class="form-control" id="no" name="number" placeholder="Contact No" required>
                                                    </div>
                                                </div>
                                            </fieldset>
                                                        ...
                                                        <div class="card shadow-sm mb-2">
                                                            <div class="card-body p-2">                                                                                                
                                                                <div class="d-flex justify-content-around">
                                                                    <label class="px-1"><input type="radio" name="storage" value="16gb" required> 16GB</label>
                                                            ...
                                                            <div class="card-body p-2">
                                                                <div class="form-group d-flex justify-content-around">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="bodyCondition" value="A" required>
                                        ...
                                        <div class="col-md-12 pr-3">
                                                        ...
                                                        <div class="">                                                               
                                                            <div class="form-group row pl-2">
                                                                <div class="form-check col-4">
                                                                    <input class="form-check-input" type="radio" id="okGlass" name="screen_glass" value="full-clear" required>
                                                ...
                                                <div class="row no-gutters">                                                       
                                                    <div class="col-12 pl-3">                                                            
                                                        <div class="">
                                                            <div class="form-group row pl-2">
                                                                <div class="form-check col-4">
                                                                    <input class="form-check-input" type="checkbox" id="Broken" name="lcd_condition[]" value="broken-lcd" required>
                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-12 mb-2">
                                                    ...
                                                    <select class="form-control" id="WorkingCondition" name="WorkingCondition" required>
...
<div class="modal fade" id="createAccessory" tabindex="-1" role="dialog" aria-labelledby="createModalTitle1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <form enctype="multipart/form-data" method="POST" action="{{route('seller.accessoryStore')}}">
             @csrf
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h5 class="modal-title" id="editModalLongTitle">{{__('Add')}}</h5>
                ...
                <div class="modal-body">                                
                    <ul class="nav nav-tabs" id="myTab" role="tablist">                       
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Product Category Form</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">                                                    
                                    ...
                                    <div class="form-section">                                           
                                        <fieldset class="shadow-sm p-3 bg-white">
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-6 form-group">
                                                    <label class="mb-0" for="companyModel">Sub-Category:</label>
                                                    <select class="form-control" id="sub_category" name="sub_category">
                                                        ...
                                                        <option value="AirBuds">Air Buds</option>
                                                ...
                                                {{-- <div class="col-6 form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="discountPrice" name="discountPrice" placeholder="Discount Price">
                                                </div> --}}
                                                <div class="col-6 form-group">
                                                    <label class="mb-0" for="image">Primary Image:</label>                                                    
                                                    <input type="file" class="form-control" id="image" name="image" required>
                                                </div>
                                                <div class="text-right col-6 pt-2 justify-content-end px-2">
                                                ...
                                                <fieldset class="shadow-sm p-3 bg-white">
                                                    ...
                                                    <div class="row no-gutters">
                                                        ...
                                                        <div class="col-6" id="brand_2">
                                                            <label for="brand">Brand</label>
                                                            <select class="form-control" id="brand2" name="brand_id" required>
                                                                <option value="" selected disabled>Please Select Brand</option>
                                                                @foreach ($brands as $brand )
                                                                    <option value="{{ $brand->id}}"> {{ $brand->en_BrandName }}</option>
                                                                @endforeach                                                               
                                                        ...
                                                        <div class="col-6 pr-2">
                                                            <label for="model">Model</label>
                                                            <input type="text" class="form-control" id="model2" name="model">
                                                        </div>
                                                        <div class="col-6">
                                                            <label for="color">Color</label>
                                            ...
                                            <div class="col-12 pr-3">
                                                <fieldset class="shadow-sm p-3 bg-white">
                                                    ...
                                                    <div class="row no-gutters">
                                                        ...
                                                        <div class="col-4 pr-2 mb-2">
                                                            <label for="price">Price:</label>
                                                            <input type="text" class="form-control" id="price_1" name="price">
                                                        </div>
                                                        <div class="col-12">
                                                            <label for="description">Description:</label>
...
{{-- Edit Form--}}
<div class="modal fade" id="updateAccessory" tabindex="-1" role="dialog" aria-labelledby="updateAccessory" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <form enctype="multipart/form-data" method="POST" action="{{route('seller.accessoryUpdate')}}">
        @csrf
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title text-white" id="editModalLongTitle">{{__('Edit')}}</h5>
                    ...
                    <div class="modal-body">                                
                        <ul class="nav nav-tabs" id="myTab" role="tablist">                            
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="profile2-tab" data-bs-toggle="tab" data-bs-target="#profile2" type="button" role="tab" aria-controls="profile2" aria-selected="false">Product Category Form</button>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">                                                   
                            <div class="tab-pane fade show active" id="profile2" role="tabpanel" aria-labelledby="profile2-tab">
                                ...
                                <div class="container-fluid">
                                    <h2 class="text-center mb-4">Product Information Form</h2>
                                    <input type="hidden" id="accessoryId" name="accessoryId" value="">  
                                    <div class="form-section">                                           
                                        <fieldset class="shadow-sm p-3 bg-white">
                                            <legend>Product Category Form</legend>
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-6 form-group pr-3">
                                                    <label class="mb-0" for="category">Category:</label> 
                                                    <select class="form-control" id="categoryAcc" name="category">
                                                        <option value="" selected disabled>Please Select Category</option>                                                       
                                                        <option value="smartWatch">Smart Watch</option>
                                                        <option value="accessories">Accessories</option>
                                                        {{-- <option value="parts">Parts</option> --}}
                                                ...
                                                <div class="col-6 form-group">
                                                    <label class="mb-0" for="companyModel">Sub-Category:</label>
                                                    <select class="form-control" id="subCategoryAcc" name="sub_category">
                                                        <option value="" selected>Please Select Sub-Category</option>                                                       
                                                        <option value="Charger">Charger</option>
                                                        <option value="HandsFree">Hands Free</option>
                                                        <option value="HeadPhone">Head Phone</option>
                                                ...
                                                <div class="col-6 form-group">
                                                    <label class="mb-0" for="price">Price:</label>
                                                    <input type="text" class="form-control" id="priceAcc" name="price" placeholder="Price">
                                                </div>
                                                {{-- <div class="col-6 form-group">
                                                    <label class="mb-0" for="discountPrice">Discount Price:</label>
                                                    <input type="text" class="form-control" id="discountPriceAcc" name="discountPrice" placeholder="Discount Price">
                                                </div> --}}
                                                <div class="col-6 form-group">
                                                    <label class="mb-0" for="image">Image:</label>
                                                    <input type="hidden" id="imageAcc">
                                                    <input type="file" class="form-control" id="imageAcc" name="image">
                                                </div>
                                                <div class="text-right col-6 pt-2 justify-content-end px-2">
                                                    <label for="exampleInputEmail1">{{ __('Image 2') }}</label>
                                                    <input type="file" class="form-control putImage2" name="image_two" id="image_two">                                                    
                                                ...
                                                <div class="col-12 form-group">
                                                    <label class="mb-0" for="description">Description:</label>
                                                    <textarea class="form-control" id="descriptionAcc" name="description" placeholder="Description" rows="5"></textarea>
                                                </div>                                                                            
                                            </div>
                                        </fieldset>
                                    </div>
...
<script>
    ...
    function editAccessory(id) {
        $.ajax({
            url: "{{ url('seller/accessoryEdit/') }}" + "/" + id,
            success: function(data) {
                console.log(data.price)
                $("#updateAccessory").modal("show");
                $("#accessoryId").val(id);                                
                $("#categoryAcc").val(data.category);
                $("#subCategoryAcc").val(data.sub_category);
                $("#imageAcc").val(data.image);
                $("#priceAcc").val(data.price);             
                $("#descriptionAcc").val(data.description);                                  
            }
        })
    }
</script>
...
<script>
    $(document).ready(function() {
        ...
        $('[data-toggle="tooltip"]').on('click', function () {
            ...
            $.ajax({
                url: '/admin/toggle-is-admin-approval/' + productId,
                method: 'GET',
                success: function (response) {
                    // Handle success, update UI
                    console.log(response);

                    // Update UI text and class
                    var newStatus = response.new_status;
                    element.text(newStatus ? 'Approved' : 'Pending');
                    
                    // Update badge class
                    var badgeClass = newStatus ? 'bg-success text-white' : 'bg-warning text-white';
                    element.removeClass().addClass('p-2 rounded cursor-pointer ' + badgeClass);
                },
        ...
        $('[data-toggle="tooltip-acc"]').on('click', function () {
            var productId = $(this).data('product-id');
            var element = $(this);

            $.ajax({
                url: '/admin/accessory-admin-approval/' + productId,
                method: 'GET',
                success: function (response) {
                    // Handle success, update UI
                    console.log(response);
