...
<body>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6 col-7">
                            <div class="hero-content">
                                <h1 class="hero-title">Exclusive Summer Sale is Going On Zaaminn The Shopify </h1>
    ...
    <div class="image-gallery-area-v2 section-top pb-110">
        <div class="container">
            <div class="section-header-two text-center">
                <h2 class="section-title"> Zaaminn Gallery <br /> For Online Experience</h2>
            </div>
            <div class="row">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <div class="blog-top-left">
                            <h2 class="blog-left-title">News And Views From <br /> The Zaaminn Blog</h2>
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-md-12">
                                    <div class="offer_modal_left">
                                        ...
                                        <p class="m-0">Subscribe to the Zaaminn mailing list to receive updates
