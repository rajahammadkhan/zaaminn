                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="sidebar-widget-area mobile-sidebar">
                        ...
                        <div class="single-widget categories-widget">
                            <h1 class="widget-title">{{ __('Categories') }}</h1>
                            <div class="categories-list">
                               @foreach (Category() as $item)
                                    <div class="single-categorie">
                                        <div class="categorie-left">
                                            <input class="form-check-input CheckCategory" type="checkbox"
                                                value="{{ $item->en_Category_Name }}">
                                            <label class="form-check-label">{{ $item->en_Category_Name }}</label>
                                        </div>
                                        <span class="categories-count">{{ productCategoryCount($item->id) }}</span>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                ...
                <div class="col-xl-9 col-lg-8">
                    ...
                    <div id="filterProduct">
                        <div class="product-list">
                            ...
                            <div class="row">
                             @foreach ($seller_products as $sellerProduct)
                                    <div class="col-xl-2 col-lg-6 col-md-4 col-sm-6">
                                        <div class="single-grid-product">
                                            <div class="product-top">
                                                ...
                                                <div class="product-info text-center">
                                                    <div class="text-center">
                                                        <span class="text-dark">{{ $sellerProduct->description }}</span>                                                        
                                                    </div>
                                                </div>
                                                <div class="product-info text-center">
                                                    <div class="product-price">
                                                        <span
                                                            class="price">{{ currencyConverter($sellerProduct->price) }}</span>
                                                        
                                                    </div>

                                                    <a href="javascript:void(0)" title="{{ __('Add to cart') }}"
                                                       class="add-cart addCart"
                                                       data-id="{{ $sellerProduct->id }}">{{ __('Add To Cart') }} <i
                                                           class="icon fas fa-plus-circle"></i></a>
                                                </div>
                                                <ul class="prdouct-btn-wrapper">
                                                    <li class="single-product-btn">
                                                        <a class="product-btn CompareList"
                                                            data-id="{{ $sellerProduct->id }}"
                                                            title="{{ __('Add To Compare') }}"><i
                                                                class="icon flaticon-bar-chart"></i></a>
                                                    </li>
                                                    <li class="single-product-btn">
