                            ...
                            <ul class="product-thumb-silide-v2">
                                ...
                                <li class="single-item">
                                    <img class="single-item-image"
                                        src="{{ asset(ProductImage() . $products->Primary_Image) }}" style="width: 380px;
                                                                 height: 360px;
                                                                 object-fit: contain;" alt="{{ __('product') }}" />
                                </li>
                                @if ($products->Image4)
                                <li class="single-item">
                                    <img class="single-item-image" src="{{ asset(ProductImage() . $products->Image4) }}"
                                        style="width: 380px;
                                                                 height: 360px;
                                                                 object-fit: contain;" alt="{{ __('product') }}" />
                                </li>
                                ...
                                @if ($products->Image3)
                                <li class="single-item">
                                    <img class="single-item-image" src="{{ asset(ProductImage() . $products->Image3) }}"
                                        style="width: 380px;
                                                                 height: 360px;
                                                                 object-fit: contain;" alt="{{ __('product') }}" />
                                </li>
                                ...
                                @if ($products->Image5)
                                <li class="single-item">
                                    <img class="single-item-image" src="{{ asset(ProductImage() . $products->Image5) }}"
                                        style="width: 380px;
                                                                 height: 360px;
                                                                 object-fit: contain;" alt="{{ __('product') }}" />
                                </li>
                                ...
                                @if ($products->Image2)
                                <li class="single-item">
                                    <img class="single-item-image" src="{{ asset(ProductImage() . $products->Image2) }}"
                                        style="width: 380px;
                                                                 height: 360px;
                                                                 object-fit: contain;" alt="{{ __('product') }}" />
                                </li>
                    ...
                    <div class="product-single-right">
                        <div class="product-info">
                            ...
                            <div class="product-price">
                                @if (currencyConverter($products->Discount_Price) ==
                            ...
                            <div class="product-color-area ">
                                ...
                                <h4 class="color-title " hidden>COLOR</h4>
                                <div class="variable-single-item color-switch" hidden>
                            ...
                            <div class="product-bottom-button d-flex" >
                                <a href="javascript:void(0)" class="primary-btn buyNow" data-id="{{ $products->id }}">{{
                                    __('Buy Now') }}</a>

                                <a class="product-btn MyWishList" data-id="{{ $products->id }}" hidden
                                    title="{{ __('Add To Wishlist') }}"><i class="icon flaticon-like"></i></a>
                                <a class="product-btn CompareList d-none" data-id="{{ $products->id }}" hidden
                        ...
                        <div class="product-right-bottom">
                            <ul class="features">
                                <li class="single-feature">
                                    <img class="icon" src="{{ asset('frontend/assets/images/delivery-van-icon.svg') }}"
                                        alt="icon" /><strong class="feature-title">{{ __('Estimated Delivery:')
                                        }}</strong><span class="feature-text">{{ allsetting()['estimating_delivery']
                                        }}</span>
                                </li>
                                <li class="single-feature">
                                    <img class="icon" src="{{ asset('frontend/assets/images/shipping-return.svg') }}"
                            ...
                            @if ($allsettings['news_letter_status'] == '1' && 1==12)
                            ...
                            <div class="share-area d-flex align-items-center mt-30 d-none">
                                <h3 class="share-title">{{ __('SHARE:') }}</h3>
                                <ul class="social-media a2a_kit">
                                    <li class="media-item">
                                        <a class="media-link facebook a2a_button_facebook" href="javascript:void(0)"><i
                                    ...
                                    <li class="media-item">
                                        <a class="media-link linkedin a2a_button_linkedin" href="javascript:void(0)"><i
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="single-grid-product-v2">
                    <div class="product-top">
                        ...
                        <ul class="prdouct-btn-wrapper d-none">
                            ...
                            <li class="single-product-btn d-none">
                    ...
                    <div class="product-info text-center">
                        ...
                        <h3 class="product-name"><a class="product-link"
                                ...
                                langConverter($product->en_Product_Name, $product->fr_Product_Name) }}</a>
                        </h3>
                        <!-- This is server side code. User can not modify it. -->
