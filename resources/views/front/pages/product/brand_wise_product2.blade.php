...
{{--                        </div>--}}
                        ...
                        <div class="single-widget brand-widget">
                            ...
                            <div class="brand-list" data-is-admin="{{ $isAdmin ? 'true' : 'false' }}">
                                @foreach($brands as $brand)
                                    <div class="single-brand">
                                        ...
                                        <span class="brand-count">{{sellerProductBrandCount($brand->id)}}</span>
                                    </div>
                                @endforeach
                            </div>
                        </div>                       
                                        ...
                                        <div class="single-grid-product">
                                            <div class="product-top">
                                                <a href="{{route('seller.product',$product->id)}}">
                                                    <img class="product-thumbnal" src="{{asset($product->image)}}" style="width: 350px;height: 240px;object-fit: contain;" alt="product" /></a>
                                                <div class="product-flags">
                                                    @if($product->ItemTag)
                                                        <span class="product-flag sale">{{$product->ItemTag}}</span>
                                                    @endif
                                                    @if($product->discountPrice )
                                                        <span class="product-flag discount">{{ __('-')}}{{$product->discountPrice}}</span>
                                                    @endif
                                                </div>
                                            ...
                                            <div class="product-info text-center">
                                                ...
                                                <h4 class="text-left pl-2 mb-0" style="line-height: 1.5; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                                                ...
                                                <div class="product-price">
                                                    ...
                                                    {{-- <span class="price">{{currencyConverter($product->discountPrice)}}</span> --}}
                                                </div>
                                                <input type="hidden" name="quantity" value="1" id="product_quantity">
