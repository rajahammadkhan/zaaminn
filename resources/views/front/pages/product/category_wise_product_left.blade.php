        ...
        <div class="container">
            <div class="breadcrumb-wrap text-center">
                ...
                <ul class="breadcrumb-pages">
                    ...
                    <li class="page-item">{{langConverter($category_m->en_Category_Name, $category_m->fr_Category_Name)}}</li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-md-3">
                                <div class="product-section-top-left">
                                    ...
                                    <div class="list-grid-view">
                                        <a href="{{route('category.product_left', $category_m->id)}}" class="view-btn list-view active"><img class="view-icon" src="{{asset('frontend/assets/images/view-list.svg')}}" alt="view-list" /></a>
                                        <a href="{{route('brand.product', $category_m->id)}}" class="view-btn grid-view"><img class="view-icon" src="{{asset('frontend/assets/images/view-grid.svg')}}" alt="view-grid" /></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-9">
                                    ...
                                    <form>
                                        <select class="form-select sortingFilter" >
                                            ...
                                            @foreach(Category() as $item)
                                                <option  value="{{route('category.product_left', $item->id)}}">{{ langConverter($item->en_Category_Name, $item->fr_Category_Name)  }}</option>
                                            @endforeach
                                        </select>
                                    </form>
                                </div>
                            ...
                            @forelse($products as $product)
                                <div class="single-list-product">
                                    ...
                                    <div class="product-right">
                                        ...
                                        </div> <input type="hidden" name="quantity" value="1" id="product_quantity">
                                        ...
                                        <ul class="prdouct-btn-wrapper d-flex align-items-center">
                                            ...
                                            <li class="single-product-btn">
                                                <a class="product-btn MyWishList" data-id="{{$product->id}}" title="Add to wishlist"><i class="icon flaticon-like"></i></a>
                                            </li>
                                            <li class="single-product-btn">
                                                <a class="product-btn CompareList" data-id="{{$product->id}}" title="Add to compare"><i class="icon flaticon-bar-chart"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
