                    ...
                    <div class="product-item cart-product-item">
                        <div class="single-grid-product">
                            <div class="product-top">
                                @if($item->options->type == 'Seller')
                                <a href="javascript:void(0)"><img class="product-thumbnal"
                                    src="{{ asset($item->options->image) }}" alt="cart">
                                </a>
                                @else
                                <a href="javascript:void(0)"><img class="product-thumbnal"
                                    src="{{ asset(ProductImage() . $item->options->image) }}" alt="cart">
                                </a>
                                @endif
                            </div>
                            <div class="product-info">
                                ...
                                <div class="product-price">
                                    @if($item->options->type == 'Seller')
                                    <h6>{{$item->options->type}}</h6>
                                    @endif
                                    @if($item->options->type == null)
