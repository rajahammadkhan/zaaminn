<div class="section-wrap account-page-sidemenu user-profile-sidebar">
    <nav class="account-page-menu">
        <ul>
            ...
            <li class="{{$menu == 'ads' ? 'active' : ''}}"><a href="{{route('user.profile.myAds')}}"><i class="fas fa-box-open"></i>{{__('My Ads')}}</a></li>
            <li class="{{$menu == 'wishlist' ? 'active' : ''}}"><a href="{{route('user.profile.myWishlist')}}"><i class="fas fa-box-open"></i>{{__('My Wishlist')}}</a></li>
