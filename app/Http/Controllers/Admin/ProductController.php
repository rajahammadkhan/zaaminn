...
class ProductController extends Controller
{
    ...
    public function physicalProductAdd($data)
    {
        ...
        $product = Product::create([
            ...
            'ram' => $data['ram'],
            'is_true_tone' => isset($data['is_true_tone']) ? $data['is_true_tone'] : '0',
            'bodyCondition' => $data['bodyCondition'],
            'iphone_message' => isset($data['iphone_message']) ? $data['iphone_message'] : '',
            'battery_status' => isset($data['battery_status']) ? $data['battery_status'] : '',            
            'screen_glass' => $data['screen_glass'],
            'lcd_condition' => isset($data['lcd_condition']) ? $data['lcd_condition'] : '',
            'WorkingCondition' => $data['WorkingCondition'],
            'issues' => isset($data['issues']) ? $data['issues'] : '',
            'is_carrier_lock' => $data['is_carrier_lock'],
            'is_pta_official' => isset($data['is_pta_official']) ? $data['is_pta_official'] : 0,          
            'sim' => isset($data['sim']) ? $data['sim'] : '',                     
            'is_official_warranty' => $data['is_official_warranty'],
            'is_sim_working' => isset($data['is_sim_working']) ? $data['is_sim_working'] : 0,
            'warrantyMonths' => isset($data['warrantyMonths']) ? $data['warrantyMonths'] : 0,                     
...
//            'fr_AdditionalInformation' => $data['fr_additionalinformation'],
    ...
    public function physicalProductUpdate($data, $product)
    {
        ...
        $update = $product->update([
            ...
            'sim' => isset($data['sim']) ? $data['sim'] : '',
            'is_official_warranty' => $data['is_official_warranty'],
            'is_sim_working' => isset($data['is_sim_working']) ? $data['is_sim_working'] : NULL,
            'warrantyMonths' => isset($data['warrantyMonths']) ? $data['warrantyMonths'] : 0,
