...
class UserProfileController extends Controller
{
      ...
      public function myWishlist()
    {
        ...
        $data['description'] = __('Wishlist');
        $data['keywords'] = __('Wishlist');
        $data['wishlists'] = Wishlist::where('user_id', Auth::id())->with('product')->get();
        return view('front.pages.user_profile.my_wishlist', $data);
    }

    public function myAds()
    {
        $data['title'] = __('My Ads');
        $data['description'] = __('My Ads');
        $data['keywords'] = __('My Ads');
        return view('front.pages.user_profile.my_ads', $data);
    }
