...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'is_admin', 'en.locale'], 'as' => 'admin.'], function () {
    ...
    Route::get('/sellerProduct', [SellerController::class, 'index'])->name('sellerProduct');
    Route::get('/toggle-is-admin-approval/{id}', [SellerController::class, 'toggleIsAdminApproval']);
    Route::get('/accessory-admin-approval/{id}', [SellerController::class, 'accessoryAdminApproval']);
