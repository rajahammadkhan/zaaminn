...
Route::get('seller_products_page', [HomeController::class, 'sellerProductsPage']);
...
Route::get('/zaaminn', [ProductController::class, 'productForm']);
...
Route::group(['middleware' => ['is_user']], function () {
    ...
    Route::group(['prefix' => 'user/'], function () {
        ...
        Route::group(['middleware' => 'auth'], function () {
            ...
            Route::get('my-ads', [UserProfileController::class, 'myAds'])->name('user.profile.myAds');
    ...
    Route::group(['prefix' => 'product'], function () {
        ...
        Route::get('seller/single/{slug}', [SellerController::class, 'singleProduct'])->name('seller.product');
        Route::get('seller/accessories/{id}', [SellerController::class, 'singleAccessory'])->name('seller.accessory');
...
Route::post('/seller/sellerSignIn', [SellerController::class, 'sellerSignIn'])->name('seller.sellerSignIn');
Route::get('/seller/store', [SellerController::class, 'signUp']);
Route::post('/seller/sellerSignUp', [SellerController::class, 'sellerSignUp'])->name('seller.sellerSignUp');

Route::group(['middleware' => ['auth', 'seller']], function () {
    Route::get('/seller/dashboard', [SellerController::class, 'dashboard'])->name('seller.dashboard');
    Route::get('/seller/user/buyer', [SellerController::class, 'becomeBuyer'])->name('user.buyer');
    Route::get('/seller/editProfile', [SellerController::class, 'editSellerProfile'])->name('editSellerProfile');
    Route::get('/seller/sellerProduct', [SellerController::class, 'sellerProducts'])->name('seller.sellerProduct');
    Route::post('/seller/profile-update', [SellerController::class, 'sellerProfileUpdate'])->name('seller.profile.update');
    Route::post('/seller/change-password', [SellerController::class, 'changePassword'])->name('seller.change_password');
    Route::get('/seller/logout', [SellerController::class, 'logout'])->name('seller.logout');
});
Route::group(['middleware' => ['auth']], function () {
    Route::post('/seller/productStore', [SellerController::class, 'productStore'])->name('seller.productStore');
    Route::get('seller/productEdit/{id}', [SellerController::class, 'editProduct'])->name('seller.seller/productEdit');
    Route::post('seller/productUpdate', [SellerController::class, 'productUpdate'])->name('seller.productUpdate');
    Route::get('seller/productDelete/{id}', [SellerController::class, 'destroy'])->name('seller.productDelete');    
    
    Route::post('/seller/accessoryStore', [SellerController::class, 'accessoryStore'])->name('seller.accessoryStore');
    Route::get('seller/accessoryEdit/{id}', [SellerController::class, 'editAccessory'])->name('seller.accessoryEdit');
    Route::post('seller/accessoryUpdate', [SellerController::class, 'accessoryUpdate'])->name('seller.accessoryUpdate');
    Route::get('seller/accessoryDelete/{id}', [SellerController::class, 'destroyAccessory'])->name('seller.accessoryDelete');    
});
